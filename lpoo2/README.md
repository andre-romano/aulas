# Linguagem de Programacao Orientada a Objetos II (LPOO II)

Esta página contém as aulas e demais o conteúdos auxiliares da disciplina.

**Sumário**
- [Linguagem de Programacao Orientada a Objetos II (LPOO II)](#linguagem-de-programacao-orientada-a-objetos-ii-lpoo-ii)
...
As aulas podem ser acessadas [nesta pasta compartilhada](https://drive.google.com/drive/folders/1lZ0hgbSYBvrH1lYvwAb2lJ2FT0-Z4qH6?usp=sharing)

## Guias de Estudo

- [1 - Conceitos básicos de POO (Classes e Objetos)](./1_classe_e_objetos.md)
- [2 - Pilares de OO (Encapsulamento, Herança, Polimorfismo e Abstração)](./2_pilares_poo.md)
...
- [3 - Heranca](https://www.youtube.com/watch?v=2IUMpxrvVjA&list=PLqsF5rntN2nYRJLNyfCs_pvDvfAL-rAnr)
- [4 - Classes Abstratas, Associacao e Composicao](https://www.youtube.com/watch?v=V3D-a7l_eIE&list=PLqsF5rntN2naoSVFckR3-tQKqmIq1JKMw)
- [5 - Principios KISS, YAGNI, DRY](https://www.youtube.com/watch?v=5yJ_cAUrpQc)
- [6 - Principios SOLID](https://www.youtube.com/watch?v=6SfrO3D4dHM)
- [7 - Tratamento de Exceções](https://www.youtube.com/watch?v=1Dgoc6dU0JE&list=PLqsF5rntN2na6FIC_opw6hSZlR7uEHWjP)
